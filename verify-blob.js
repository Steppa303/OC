...
(async () => {
  console.log('🔍 Starte Browser-Test...');
  ...
  await page.screenshot({ 
    path: '/root/.openclaw/workspace/test-results/threejs-blob-engine/VERIFIED-screenshot.png',
    fullPage: true 
  });
  ...
  console.log('Screenshot: /root/.openclaw/workspace/test-results/threejs-blob-engine/VERIFIED-screenshot.png');
  console.log('=================================');
})();
