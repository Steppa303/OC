...
# PDF lesen
pdf_path = "/root/.openclaw/workspace/ninja-blast-max-rezepte.pdf"
...
print("📧 Sende Ninja Blast Max Rezepte an 2 Empfänger...")
...
for recipient_email, recipient_name in recipients:
    ...
    result = client.inboxes.messages.send(
        ...
        to=recipient_email,
        subject="🌶️ 3 Ninja Blast Max Rezepte (Pikant & Herzhaft)",
        text=f"""Hey {recipient_name}!

Hier sind 3 herzhafte Rezepte SPEZIFISCH für den Ninja Blast Max als PDF! 🍲

🥒 Gazpacho (Kalt, Spanisch)
🥑 Avocado-Chili Dip (Cremig, Pikant)
🍅 Enchilada-Sauce (Herzhaft, Würzig)

📄 Anhang: ninja-blast-max-rezepte.pdf
...
<p>Hier sind <strong>3 herzhafte Rezepte SPEZIFISCH für den Ninja Blast Max</strong> als PDF!</p>
...
<h3 style="color: white; margin-top: 0;">🍽️ 3 Ninja Blast Max Rezepte</h3>
<ul style="font-size: 1.1em;">
<li>🥒 <strong>Gazpacho</strong> (Kalt, Spanisch)</li>
<li>🥑 <strong>Avocado-Chili Dip</strong> (Cremig, Pikant)</li>
<li>🍅 <strong>Enchilada-Sauce</strong> (Herzhaft, Würzig)</li>
</ul>
</div>
...
""",
        attachments=[{
            "filename": "ninja-blast-max-rezepte.pdf",
            "content": pdf_base64
        }]
    )
...
print(f"📎 Anhang: ninja-blast-max-rezepte.pdf ({len(pdf_data)} bytes)")
